  ...
  links?.insertAdjacentHTML(
    ...
    `<div class="flex flex-col w- md:w-3/5 shadow-md rounded p-7 mb-8">
        ...
        <div class="flex justify-between w-full md:w-1/2 m-auto p-3">
            ...
            <a href="#!" role="button">
                <!-- X -->
                <span class="[&>svg]:h-7 [&>svg]:w-6 [&>svg]:fill-black flex items-center">
            ...
            <a href="#!" role="button" class="text-blue-600">
                <!-- Email  -->
                <span class="[&>svg]:h-7 [&>svg]:w-6 [&>svg]:fill-gray flex items-center">
            ...
            <a href="#!" role="button" class="text-blue-600">
                <!-- Email  -->
                <span class="[&>svg]:h-7 [&>svg]:w-6 flex items-center">
